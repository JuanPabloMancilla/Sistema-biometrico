...
TRADUCCIONES_UTF8 = {
    ...
    "Sin accesos registrados": {"en": "No access records found"},
    "Sin accesos registrados en esta fecha": {"en": "No access records for this date"},
    "Sin jornadas registradas en esta fecha": {"en": "No work shifts for this date"},
    "Personal trabajando ahora": {"en": "Staff currently working"},
    "Entradas hoy": {"en": "Entries today"},
    "Salidas hoy": {"en": "Exits today"},
    "Horas trabajadas": {"en": "Hours worked"},
    "Entradas y salidas por hora": {"en": "Entries and exits by hour"},
    "Entradas": {"en": "Entries"},
    "Salidas": {"en": "Exits"},
    "Reportes": {"en": "Reports"},
    "Reportes de asistencia": {"en": "Attendance reports"},
    "Desde": {"en": "From"},
    "Hasta": {"en": "To"},
    "Consultar": {"en": "Search"},
    "Exportar CSV": {"en": "Export CSV"},
    "Exportar reporte": {"en": "Export report"},
    "Sin jornadas registradas en este periodo": {"en": "No work shifts in this period"},
    "Configurar horario": {"en": "Configure schedule"},
    "Corregir ultimo marcaje": {"en": "Correct latest record"},
    "Hora de entrada (HH:MM)": {"en": "Start time (HH:MM)"},
    "Tolerancia (minutos)": {"en": "Tolerance (minutes)"},
    "Jornada objetivo (minutos)": {"en": "Target shift (minutes)"},
    "Descanso fijo (minutos)": {"en": "Fixed break (minutes)"},
    "Entrada (AAAA-MM-DD HH:MM:SS)": {"en": "Entry (YYYY-MM-DD HH:MM:SS)"},
    "Salida (vacia si sigue trabajando)": {"en": "Exit (empty if still working)"},
    "Guardar correccion": {"en": "Save correction"},
    "PRUEBA DE VIDA": {"en": "LIVENESS CHECK"},
    "PARPADEE UNA VEZ": {"en": "BLINK ONCE"},
    "PARPADEE AHORA": {"en": "BLINK NOW"},
    "ABRA LOS OJOS": {"en": "OPEN YOUR EYES"},
    "MIRE A LA CAMARA": {"en": "LOOK AT THE CAMERA"},
    "RETIRE EL ROSTRO PARA CONTINUAR": {"en": "MOVE YOUR FACE AWAY TO CONTINUE"},
    "Sin cuenta": {"en": "No account"},
    "Sin correo": {"en": "No email"},
    "Acceso autorizado": {"en": "Access authorized"},
    "Acceso denegado": {"en": "Access denied"},
